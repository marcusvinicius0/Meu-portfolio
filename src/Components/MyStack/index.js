        ...
        <div className={styles.stackContainer}>
            ...
            <div className={styles.boxesContainer}>
                ...
                <div className={styles.reactBox}>
                    ...
                    <a href="https://pt-br.reactjs.org/docs/getting-started.html" target="_blank">Ler documentação</a>
                </div>
                ...
                <div className={styles.jsBox}>
                    ...
                    <a href="https://developer.mozilla.org/pt-BR/docs/Web/JavaScript" target="_blank">Ler documentação</a>
                </div>
                ...
                <div className={styles.firebaseBox}>
                    ...
                    <a href="https://firebase.google.com/docs" target="_blank">Ler documentação</a>
                </div>
                ...
                <div className={styles.sassBox}>
                    ...
                    <a href="https://sass-lang.com/documentation/" target="_blank">Ler documentação</a>
                </div>
                ...
                <div className={styles.nodeBox}>
                    ...
                    <p>
                        ...
                        Com ele podemos construir aplicações web completas em geral, desde web sites até criações de <a href="https://pt.wikipedia.org/wiki/Interface_de_programa%C3%A7%C3%A3o_de_aplica%C3%A7%C3%B5es" target="_blank">APIs</a> e microserviços.
                    </p>
                    <a className={styles.docLink} href="https://nodejs.org/pt-br/docs/" target="_blank">Ler documentação</a>
                </div>
                ...
                <div className={styles.nextBox}>
                    ...
                    <h3>Next.js</h3>
                    <p>
                        Next.js é um <a href="https://pt.wikipedia.org/wiki/Framework" target="_blank"><strong>
                    ...
                    <a className={styles.nextLink} href="https://nextjs.org/docs" target="_blank">Ler documentação</a>
                </div>
                ...
                <div className={styles.cssBox}>
                    ...
                    <a href="https://developer.mozilla.org/pt-BR/docs/Web/CSS" target="_blank">Ler documentação</a>
                </div>
                ...
                <div className={styles.htmlBox}>
                    ...
                    <a href="https://developer.mozilla.org/pt-BR/docs/Web/HTML" target="_blank">Ler documentação</a>
                </div>
